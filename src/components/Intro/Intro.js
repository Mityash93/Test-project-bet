      ...
      <div className="container">
        <div className={s.intro__content}>
          <h1 className={s.intro__title}>
            <span className={s.intro__title_blue}>Lorem ipsum</span> dolor sit{" "}
            <br />
            amet consectetur
            <span className={s.intro__title_blue}> adipiscing</span>
          </h1>
          <h6 className={s.intro__description}>
            At vero eos et accusamus et iusto odio dignissimos ducimus!
          </h6>
          <ul className={s.intro__list}>
            <li className={s.intro__list_item}>Totam rem aperiam eaque ipsa</li>
            <li className={s.intro__list_item}>
